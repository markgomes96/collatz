...
function RecCount (n : Long_Long_Integer) return Long_Long_Integer is
begin
   if n = 1 then
      return 0;
   end if;
...
begin
    ...
    loop
        exit when num > 10000;    --Preform collatz algorithm
        n := num;
        count := RecCount(num);   --Preform recursion for collatz sequence
